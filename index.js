...
$(document).ready(function() {
	...
	var newInput = ('<div class="button-action-wrap-added"><select class="f-select"><option value="work">Work</option> <option value="mobile">Mobile</option> <option value="home">Home</option></select><input type="text" class="f-input small" name="mytext[]"/><input class="f-input xsmall" type="tel" placeholder="Ext" name="mytext[]"><div id="primary" class="primary-phone">primary</div><button href="#" class="btn--remove"><svg fill="#F96060" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"> <path d="M0 0h24v24H0z" fill="none"/> <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11H7v-2h10v2z"/></svg></button></div>')
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){
        e.preventDefault();
		$(this).parent().parent(wrapper).append('<div class="button-action-wrap-added"><input type="text" class="f-input large" name="mytext[]"/><div id="primary" class="primary-email">primary</div><button href="#" class="btn--remove"><svg fill="#F96060" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"> <path d="M0 0h24v24H0z" fill="none"/> <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm5 11H7v-2h10v2z"/></svg></button></div>'); 
    });
